...
require "#{VPSB_BASE_PATH}/vpsb_client/api/get_web_run_urls"
...
require "#{VPSB_BASE_PATH}/vpsb_client/api/get_speedtest_servers"
require "#{VPSB_BASE_PATH}/vpsb_client/api/create_speedtest_server"
